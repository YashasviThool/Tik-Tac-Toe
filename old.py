...
def start():
    body(root)
    # check_if_game_over() #it might be not working
...
def check_if_game_over():
	...
	if (game_still_going==FALSE):
		block(root)
		y=Label(root,text=str(winner)+' is current winner')
		y.grid(row=5,column=1)
		root.mainloop()
		

#i have to write running code here for minmax algo in main program logic	
